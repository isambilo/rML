...
NOTE: Use of GenAI
GenAI has been used in this assignment to support generation, debugging, and correcting Python coding errors. No other external help, consultancy, or support was sought in completing the assignment as required by instructions given in Lecture 01 or Responsible Machine Learning course.
